      ...
      <Card className="shadow-xl">
        ...
        <CardContent>
          {attendees.length > 0 ? (
            ...
            <p className="text-center text-muted-foreground py-8">No hay datos de asistencia disponibles. Por favor, comienza subiendo un CSV.</p>
          )}
        </CardContent>
        {attendees.length > 0 && (
          <CardFooter className="flex flex-col sm:flex-row justify-center items-center gap-4 pt-6 border-t">
            ...
            <Button onClick={handleStartNew} className="w-full sm:w-auto bg-accent hover:bg-accent/90 text-accent-foreground">
