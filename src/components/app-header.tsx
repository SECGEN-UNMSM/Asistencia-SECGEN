...
export default function AppHeader() {
  return (
    <header
      className="sticky flex w-full items-center justify-center top-0 z-50 border-b bg-primary shadow-sm"
      style={{ height: "var(--header-height, 4rem)" }}
    >
      <div className="container flex h-16 items-center w-full space-x-4 sm:justify-center sm:space-x-0 px-4 md:px-6">
        <Link
          href="/"
